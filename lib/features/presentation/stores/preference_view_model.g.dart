...
mixin _$PreferenceViewModel on _PreferenceViewModelBase, Store {
  late final _$isLoadingAtom = Atom(
    name: '_PreferenceViewModelBase.isLoading',
    context: context,
  );
  ...
  late final _$preferenceIdAtom = Atom(
    name: '_PreferenceViewModelBase.preferenceId',
    context: context,
  );
  ...
  late final _$errorMessageAtom = Atom(
    name: '_PreferenceViewModelBase.errorMessage',
    context: context,
  );
  ...
  Future<void> createPreference(List<Produto> cartItems) {
    return _$createPreferenceAsyncAction.run(
      () => super.createPreference(cartItems),
    );
  }
